...
class reservesGateway{

    private $connection;
    private $table = "G_RESERV";
    ...
    public function read_single($publication_id) {
      ...
      SELECT g_reserv."CODE", g_reserv."NOM", g_prov."PROVINCE"
...
SELECT R1.totalP, R2.totalR, (R2.totalR / R1.totalP) *100 as totalT
FROM 
